...
<div className="dark:bg-gray-900 bg-white">
        <div className="flex">
            ...
            <div className="w-2/5 dark:text-white text-slate-900 h-12 pl-32 py-4 h-auto">
                {/* <!--left menu--> */}
                <svg fill="black" height="60px" width="60px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
        ...
        <div className="flex-shrink-0 flex hover:bg-gray-00 rounded-full p-4 mt-12 mr-2">
          <a href="#" className="flex-shrink-0 group block">
            ...
            <div className="w-3/5 border border-gray-600 h-auto  border-t-0">
                ...
                <div className="flex">
                    ...
                    <div className="flex-1 px-2 pt-2 mt-2">
                        <textarea className="border-none bg-transparent text-gray-400 font-medium text-lg w-full" rows={2} cols={50} placeholder="What's happening?"></textarea>
                    </div>                    
                </div>
                ...
                <div className="flex">
                    ...
                    <div className="flex-1">
                        <button className="bg-blue-400 hover:bg-blue-500 dark:bg-gray-400 mt-5 dark:hover:bg-gray-600 text-white text-slate-900 font-bold py-2 px-8 rounded-full mr-8 float-right">
                            Tweet
                          </button>
                    </div>
                </div>
            ...
            <div className="w-2/5 h-12">
                ...
                <div className="relative text-black dark:text-gray-300 w-80 p-5 pb-0 mr-16">
                    <button type="submit" className="absolute ml-4 mt-3 mr-4 border">
                        <svg className="h-4 w-4 fill-slate-800" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 56.966 56.966" xmlSpace="preserve" width="512px" height="512px">
                          <path d="M55.146,51.887L41.588,37.786c3.486-4.144,5.396-9.358,5.396-14.786c0-12.682-10.318-23-23-23s-23,10.318-23,23  s10.318,23,23,23c4.761,0,9.298-1.436,13.177-4.162l13.661,14.208c0.571,0.593,1.339,0.92,2.162,0.92  c0.779,0,1.518-0.297,2.079-0.837C56.255,54.982,56.293,53.08,55.146,51.887z M23.984,6c9.374,0,17,7.626,17,17s-7.626,17-17,17  s-17-7.626-17-17S14.61,6,23.984,6z"/>
                        </svg>
                      </button>

                    <input type="search" name="search" placeholder="Search Twitter" className="dark:bg-gray-800 drop-shadow-2xl h-10 px-10 pr-5 w-full rounded-full text-sm focus:outline-none bg-purple-white shadow rounded border-0"/>
                ...
                <div className="max-w-sm rounded-lg dark:bg-gray-800 overflow-hidden shadow-lg m-4 mr-20 border drop-shadow-2xl">
                    <div className="flex">
                        <div className="flex-1 m-2">
                            <h2 className="px-4 py-2 text-xl w-48 font-semibold dark:text-white text-slate-900">Media</h2>
                        </div>
                        <div className="flex-1 px-4 py-2 m-2">
                            <a href="" className=" text-2xl rounded-full dark:text-white text-slate-900 dark:hover:bg-gray-800 hover:text-blue-300 float-right">
                    ...
                    <div className="flex">
                        ...
                        <div className="flex-1 px-4 py-2 m-2">
                            <a href="" className=" text-2xl rounded-full text-gray-400 dark:hover:bg-gray-800 hover:text-blue-300 float-right">
                ...
                <div className="max-w-sm rounded-lg dark:bg-gray-800 overflow-hidden shadow-2xl m-4 mr-20">
                    <div className="flex">
                        <div className="flex-1 m-2">
            ...
            <div className="flow-root m-6 inline">
                <div className="flex-1">
                    <a href="#">
                    <p className="text-sm leading-6 font-medium dark:text-gray-500">Terms Privacy Policy Cookies Imprint Ads info</p>
                  	</a>
           		 </div>
