    ...
    return (
        <div className="w-full lg:w-1/4 pl-4 lg:pl-0 pr-6 mt-8 mb-4">
            ...
            <nav className="mt-5 px-2">
                ...
                <Link href="/dashboard" className="text-blue-300 mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:border hover:border-gray-300 hover:text-blue-300">
